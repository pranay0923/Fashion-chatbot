...
def setup_openai():
    """Setup OpenAI API and return models using environment variable."""
    ...
    return chatgpt, openai_embed_model, openai_native_client
...
# ===== PART 8: ENHANCED FASHION CHATBOT =====
...
def enhanced_fashion_chat_interface(enhanced_chatbot):
...
def main():
    """Main function to run the Enhanced Fashion Chatbot"""
    
    print("🚀 Initializing Enhanced Fashion Chatbot...")
    
    try:
        # 1. Setup OpenAI
        print("\n1️⃣ Setting up OpenAI API...")
        chatgpt, openai_embed_model, openai_native_client = setup_openai()
        ...
        print("3️⃣ Setting up recommendation engine...")
        rec_engine = FashionRecommendationEngine(fashion_db)
        
        # 4. Create vector store
        print("4️⃣ Creating vector store...")
        vectorstore = create_fashion_vector_store(fashion_db, openai_embed_model)
        
        # 5. Create retriever
        print("5️⃣ Setting up retriever...")
        fashion_retriever = vectorstore.as_retriever(
            search_type="similarity", 
            search_kwargs={"k": 5}
        )
        
        # 6. Initialize enhanced chatbot
        print("6️⃣ Initializing enhanced chatbot...")
        ...
        enhanced_fashion_chat_interface(enhanced_chatbot)
        
    except KeyboardInterrupt:
        print("\n\n👋 Goodbye! Thanks for using the Fashion Chatbot!")
    except Exception as e:
